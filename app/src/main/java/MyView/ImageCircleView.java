...
public class ImageCircleView extends ImageView {
    ...
    private String PATH_ICON = "tginformation/icon";
    ...
    public void setImageURL(String url, String defImgPath) {
        if (url != null && url.equals(currentUrl)) {
            return;
        }
    ...
    private Bitmap getImageFromExternalStorage() {
        ...
        try {
            Bitmap bm = BitmapGetter.getUnderMaxSizeImage(rootPath
                    + File.separator + currentUrlKey, maxWidth, maxHeight);
