...
import bruse.ui.CropImageActivity;
import bruse.ui.ScaleCropImageActivity;
...
public class Crop {
    ...
    public void start(Fragment fragment) {
        fragment.startActivityForResult(getIntent(fragment.getActivity()), REQUEST_CROP);
    }

    public void startScale(Fragment fragment) {
        fragment.startActivityForResult(getScaleIntent(fragment.getActivity()), REQUEST_CROP);
    }
    ...
    public void startScale(Context context, Fragment fragment) {
    ...
    public void startScale(Context context, android.support.v4.app.Fragment fragment) {
        fragment.startActivityForResult(getScaleIntent(context), REQUEST_CROP);
    }
