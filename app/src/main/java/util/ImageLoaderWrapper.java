...
public class ImageLoaderWrapper {
    ...
    public AbsListView.OnScrollListener newScrollListenerWithTheImageLoader(
    ...
    public void displayImage(String imageUri, ImageView imageView,
        ...
        DisplayImageOptions options = new DisplayImageOptions.Builder()
                ...
                .imageScaleType(config.imageScaleType)
                .resetViewBeforeLoading(config.isResetView)
                .bitmapConfig(Bitmap.Config.RGB_565).displayer(config.displayer)
    ...
    public void clearDefaultLoaderCache(String url){
        sDefaultInstance.removeMemoryFromCache(url);
        sDefaultInstance.removeDiscFromCache(url);
    }
